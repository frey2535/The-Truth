...
assert.equal(verseRelatedToQuestion(samples[8], savedAsk), false);
...
assert.match(openAnswer, /Believe/);
...
const yn = yesNoOpening(baptismAsk, samples.slice(0, 8));
assert.match(yn, /do not speak with one wording/);
