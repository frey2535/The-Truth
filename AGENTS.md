...
- Research, Investigate, Assistant, and Word Study search only texts and published records stored in the app (King James and the other older complete Bibles, Apocrypha, DSS, Enoch, fathers, Philo, Josephus, Gilgamesh, and `src/data/inAppArchive.js`). Do not send study questions to the internet or invent missing archives. Do not add modern Bibles that omit verses (NIV, ESV, and the like).
