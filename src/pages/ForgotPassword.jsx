    ...
    >
      {sent ? (
        <div className="text-sm text-foreground text-center space-y-3">
          <p>If an account exists with that email, a password reset link was created.</p>
          {resetUrl && (
            <p>
              <a href={resetUrl} className="text-primary font-medium hover:underline break-all">
                {resetUrl}
              </a>
            </p>
          )}
