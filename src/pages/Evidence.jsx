    ...
    <div>
      <header className="text-center mb-8">
        ...
        <p className="text-[#5b5142] max-w-2xl mx-auto">
          Empirical holdings only: excavated objects, published inscriptions, and public-domain photographs
          of the land, each with the published wording. Tradition and uncatalogued claims are not stored here.
        </p>
