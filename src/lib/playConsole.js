...
export const PLAY_QUESTIONNAIRE = [
  ...
  },
  {
    ...
    items: [
      ...
      qa("Where to upload the .aab", "Production. This is an organization Play account — not a new personal account."),
    ],
  },
  {
    id: "closed-test",
    title: "Closed testing — skip (organization account)",
    items: [
      qa("Is this a personal Play account created after 13 Nov 2023?", "No. Current Flow Consulting is an organization Play account."),
      qa("Does this listing need 12 testers for 14 days before production?", "No. Organization accounts can send a production release for review without that closed-test gate."),
      qa("Internal testing required first?", "No. Optional only."),
      qa("Closed testing required first?", "No. Skip Closed testing unless Play later asks for it."),
      qa("What to do instead", "Test and release → Production → Create release → upload the signed .aab → submit for review."),
    ],
  },
];
